...
#                     phaseAnglesBinned.append ( int ( phaseCurveData [0][1][iPhaseAngle] )  if binRadianceFactors else  phaseCurveData [0][1][iPhaseAngle] ) 
    ...
    if not binRadianceFactors:
        ...
        yStart = 2.
        yJump = 0.14
        plt.text ( xStart, yStart, 'V1188 - V1522 (Extention 2)', c = 'purple' )
        plt.text ( xStart, yStart - yJump, 'V1748 - V2301 (Extention 3)', c = 'black' )
        plt.text ( xStart, yStart - 2 * yJump, 'V2452 - V2639 (Extention 4)', c = 'grey' )
        plt.text ( xStart, yStart - 3 * yJump, 'V2776 - V2811 (South Polar Dynamics Campaign)', c = 'red' )

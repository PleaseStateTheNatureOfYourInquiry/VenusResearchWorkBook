...
axis1.text (coordinatesFigureLabel [0], coordinatesFigureLabel [1], '(d)', fontsize = fontsizeFigureLabel, transform = axis1.transAxes)
...
axis2.text (coordinatesFigureLabel [0], coordinatesFigureLabel [1], '(e)', fontsize = fontsizeFigureLabel, transform = axis2.transAxes)
...
axis3.set_title ( 'VeRa VEX Orbit {} - {}, LST {}h, Lat {}˚'.
                  format ( VeRaProfiles ['OrbitID'][iProfile],  VeRaProfiles ['DayOfYear'][iProfile], 
                           VeRaProfiles ['LocalSolarTime'][iProfile], VeRaProfiles ['LatitudeOneBar'][iProfile] ), fontsize = 10 )
axis3.text (coordinatesFigureLabel [0], coordinatesFigureLabel [1], '(f)', fontsize = fontsizeFigureLabel, transform = axis3.transAxes)

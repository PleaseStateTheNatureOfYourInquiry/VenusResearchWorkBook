...
for altitude in altitudes:
    ...
    if correctionType == 'normalised':
        ...
        plt.title ( '(b) RFR versus Normalised Temperature at {}km'.format (altitude) )
        plt.savefig ( 'roos-serote-Figure11_RFR_vs_T_{}km_normalised.png'.format (altitude), dpi = 300 )
        ...
        plt.title ( '(a) RFR versus Temperature at {}km'.format (altitude) )
        plt.savefig ( 'roos-serote-Figure11_RFR_vs_T_{}km_uncorrected.png'.format (altitude), dpi = 300 )

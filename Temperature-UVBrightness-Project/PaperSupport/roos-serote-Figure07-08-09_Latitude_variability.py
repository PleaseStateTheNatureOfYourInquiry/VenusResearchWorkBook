...
plt.savefig ('roos-serote-Figure09.png', dpi = 300)
plt.close ()
...
#     fit = DataTools.linearLeastSquare (latitudesVeRa, cloudTopTemperatureVeRa, fractionBeyondXRange = 0.1)
    ...
    figureTexts = [ ['(a)', -10, 220], ['(b)', -10, 220], ['(c)', -10, 185] ]
    ...
    for iPlot in range ( len (altitudesToPlot) ):
        ...
        subPlotAxis [iPlot].text ( figureTexts [iPlot][1], figureTexts [iPlot][2], figureTexts [iPlot][0] )
...
#                                              pearsonStatistics [ altitudesToPlot [iPlot] - 50 ], dPearsonStatistics [ altitudesToPlot [iPlot] - 50 ] ) )
    ...
    plt.savefig ('roos-serote-Figure08.png', dpi = 300)
...
if plotToProduce ['Radiance Factor Ratios vs latitude']:
    ...
    ax1.scatter (latitudesPerOrbit [iValidOrbits], radiadanceFactorRatiosPerOrbitAverage [iValidOrbits], c = 'blue')
    ...
    plt.savefig ( 'roos-serote-Figure07_radianceFactorsRatiosAverageVMCPerOrbit_orbitLimit_{}.png'.format ( orbitIDLimit [0] ), dpi = 300 )

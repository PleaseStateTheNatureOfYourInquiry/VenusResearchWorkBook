...
abcissaListTimeDifference = [ 5, 'T_VMC - T_VeRa (h)', 'roos-serote-Figure06' ]

# # Plot RFR vs phase angle per orbit.
abcissaListPhaseAngle = [ 14, 'Phase Angle (˚)', 'roos-serote-Figure06' ]
...
def savePlotPage (iSubPlot, abcissaList1, abcissaList2):
    ...
    plt.savefig (plotPageFileName, dpi = 300)

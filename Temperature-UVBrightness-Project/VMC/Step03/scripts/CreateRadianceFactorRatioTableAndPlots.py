...
def addFigureToPage ( iSubPlot, 
    ...
    subPlotAxis [iRow, iColumn].scatter (AbcissaDataInOrbit, radianceFactorRatiosInOrbit)
...
for iImage in range (numberOfVMCImages):
    ...
    if VMCOrbitID != VMCOrbitIDsUnique [-1]:
        ...
        if createPlots and VMCOrbitID > '1188' and len (radianceFactorRatiosAveragePerOrbit):

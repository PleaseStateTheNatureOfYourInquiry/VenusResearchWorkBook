...
VeRaTools.createVeRaProfilesTable ( os.path.join (VeRaWorkBookDirectory, 'Step01', 'VeRa_LocalSolarTime_OneBarLevel_PerOrbit_SelectedProfiles.dat'), 
                                    os.path.join (VeRaDataDirectory, 'VeRa_selected_profiles') )        
VeRaTools.createVeRaProfilesTable ( os.path.join (VeRaWorkBookDirectory, 'Step01', 'VeRa_LocalSolarTime_OneBarLevel_PerOrbit_SPoleProfiles.dat'), 

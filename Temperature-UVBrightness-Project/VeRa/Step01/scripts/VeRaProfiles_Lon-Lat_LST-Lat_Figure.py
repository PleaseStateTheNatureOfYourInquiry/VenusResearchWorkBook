...
VeRa_SelectedProfiles = VeRaTools.readValuesFromVeRaTable ('../VeRa_LocalSolarTime_OneBarLevel_PerOrbit_SelectedProfiles.dat')
VeRa_SPoleProfiles = VeRaTools.readValuesFromVeRaTable ('../VeRa_LocalSolarTime_OneBarLevel_PerOrbit_SPoleProfiles.dat')
...
plt.savefig ('../plots/VeRaProfiles_Lon-Lat_Figure.png')
...
plt.savefig ('../plots/VeRaProfiles_LocalSolarTime-Lat_Figure.png')

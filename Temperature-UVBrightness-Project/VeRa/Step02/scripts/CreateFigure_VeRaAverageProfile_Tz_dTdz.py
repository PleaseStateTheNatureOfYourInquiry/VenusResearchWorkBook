...
# Create the example plots of T(z), dT/dz (z) and static stability S(z) for the last profile (iProfile = -1) in the list of used profiles (orbit 2811).
...
figure.savefig ( os.path.join ( VeRaWorkBookDirectory, 'Step02', 'plots', 'VeRaProfiles_Orb{}_T-z_Figure.png'.format ( VeRaProfiles ['OrbitID'][iProfile] ) ) )
plt.close (figure)
...
figure.savefig ( os.path.join ( VeRaWorkBookDirectory, 'Step02', 'plots', 'VeRaProfiles_Orb{}_dTdz-z_Figure.png'.format ( VeRaProfiles ['OrbitID'][iProfile] ) ) )
plt.close (figure)

...
def createVeRaProfilesDictionary (listOfVeRaProfileTABList, VeRaProfilesInformation, dictionaryFileName = ''):
    ...
    HandyTools.saveContentToNumpyWithCustomExtension ( VeRaProfiles, os.path.join ('../', dictionaryFileName), extensionWithoutDot = 'profiles', overWrite = True )



# Create and save the dictionary for the "selected profiles" (i.e. not the South Polar Dynamics Campaign).
VeRaSelectedProfilesInformation = VeRaTools.readValuesFromVeRaTable ('../../Step01/VeRa_LocalSolarTime_OneBarLevel_PerOrbit_SelectedProfiles.dat')
...
VeRaSPoleProfilesInformation = VeRaTools.readValuesFromVeRaTable ('../../Step01/VeRa_LocalSolarTime_OneBarLevel_PerOrbit_SPoleProfiles.dat')

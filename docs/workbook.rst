...
Emmanuel Marcq sent me a selection of the fits that correspond to the orbits 427 to 2811, as well as the values of the red median line of their Figure 14 above (:file:`Marcq_2020_Figure14.dat`). When I sub-select between 1188 and 2811, the orbits I use here, I get:

.. figure:: ../Temperature-UVBrightness-Project/VMC/Step03bis/plots/SPICAV-UV-Orbits_1193-2811_withO3_binsize_10.png
    :scale: 70%
...
It can be seen that the sub-set gives very similar results as the full set, with the advantage that the full set has more data points, especially around -40˚ latitude. It therefore seems reasonable to use the full set results and use these cloud top altitudes to get the corresponding atmospheric temperatures for VeRa data in the latitude bin the VeRa data has been recorded. The bins are 10˚ wide and start at whole latitude numbers. 
